import { put, takeEvery, all, call, takeLatest, take, select, fork, cancel, cancelled } from 'redux-saga/effects'
import Api from './api';
...
export function* loginFlow() {
        while (true) {
            ...
            if (action.type === 'LOGOUT')
                yield cancel(task) //If the task is still running, it'll be aborted.
                // If the task has already completed then nothing will happen and the 
                //cancellation will result in a no-op. 
            yield call(Api.clearItem, 'token')
        }
    }

//llly, like promise.all ----------
